...
last_updated: 2026-06-01T12:00:00-06:00
---
...
- <!-- id:r_sk1mp status:done completed:2026-06-01 --> ~~**Skill simplification campaign**~~ - Pared every SKILL.md to its core idea + pointers, pushing detail to `references/` and keeping load-bearing schema/frontmatter/contracts inline. **All 11 done:** track-session 483→119, deep-research 486→120, ideal-react-component 470→117, screenshot-local 461→122, setup-semantic-release 444→156, record-tui 440→116, code-review 427→104 (verifier contract preserved verbatim), track-roadmap 421→105, track-qa 340→95, rate-skill 257→185, generate-skill 249→219. **Total 4,478 → 1,458 SKILL.md lines (−67%).** One skill per commit, version-bumped, changelog'd. *(Completed: 2026-06-01)*
