...
| Ask your library | A conversational question ("what did I eat in Barcelona?") returns photos plus a written answer | Pixels, EXIF, face and place clusters, a library index | hosted | [Google Photos](https://support.google.com/photos/answer/15318661) |
...
| Proofread, rewrite, summarize on device | Highlight a passage; text leaves the device only on that explicit action | Selected text | large local | [Ulysses](https://help.ulysses.app/en_US/dive-into-editing/writing-tools) · [Apple Writing Tools](https://support.apple.com/en-us/121582) |
