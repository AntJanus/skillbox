...
| `effort` | `low`/`medium` for mechanical, well-specified work where quality holds; reserve `xhigh` for demanding coding and agentic work. Omit to inherit the session setting. |
