...
description: |
  ...
  "generate a roadmap", "let's generate a roadmap", "what should we build next",
  "pick up where I left off", "brainstorm features", "audit the roadmap",
  or when starting a new project and need to map out future work.
license: MIT
